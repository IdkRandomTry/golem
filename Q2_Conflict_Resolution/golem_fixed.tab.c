...
{
       0,    43,    43,    44,    48,    49,    50,    51,    55,    65,
      66,    70,    81,    88,    91,    92,    96,   104,   114,   115,
     119,   120,   121,   122,   123,   124,   125,   130,   137,   151,
     158,   165,   173,   177,   185,   193,   197,   208,   209,   210,
     211,   215,   216,   217,   218,   222,   223,   227,   228,   229,
     230,   234,   238,   242,   246,   250,   254,   262,   270
};
#endif
...
#line 1235 "golem_fixed.tab.c"
    break;

  case 11: /* obstacle_stmt: OBSTACLE '(' expr ',' expr ')' ';'  */
#line 71 "golem_fixed.y"
        {
...
#line 1279 "golem_fixed.tab.c"
    break;

  case 27: /* compound_stmt: '{' stmt_list '}'  */
#line 131 "golem_fixed.y"
        {
		printf("    { compound statements }\n");
	}
#line 1287 "golem_fixed.tab.c"
    break;

  case 28: /* movement_stmt: GO expr ';'  */
#line 138 "golem_fixed.y"
        {
		if ((yyvsp[-1].ival) == 0) {
...
#line 1302 "golem_fixed.tab.c"
    break;

  case 29: /* rotation_stmt: TURN direction ';'  */
#line 152 "golem_fixed.y"
        {
		printf("    turn direction;\n");
	}
#line 1310 "golem_fixed.tab.c"
    break;

  case 30: /* pick_stmt: PICK IDENTIFIER ';'  */
#line 159 "golem_fixed.y"
        {
		printf("    pick %s;\n", (yyvsp[-1].sval));
	}
#line 1318 "golem_fixed.tab.c"
    break;

  case 31: /* drop_stmt: DROP IDENTIFIER ';'  */
#line 166 "golem_fixed.y"
        {
		printf("    drop %s;\n", (yyvsp[-1].sval));
	}
#line 1326 "golem_fixed.tab.c"
    break;

  case 32: /* conditional_stmt: IF '(' condition ')' stmt  */
#line 174 "golem_fixed.y"
        {
		printf("    if (...) stmt\n");
	}
#line 1334 "golem_fixed.tab.c"
    break;

  case 33: /* conditional_stmt: IF '(' condition ')' stmt ELSE stmt  */
#line 178 "golem_fixed.y"
        {
		printf("    if (...) stmt else stmt\n");
	}
#line 1342 "golem_fixed.tab.c"
    break;

  case 34: /* repetition_stmt: REPEAT expr compound_stmt  */
#line 186 "golem_fixed.y"
        {
		if ((yyvsp[-1].ival) < 0) {
...
#line 1374 "golem_fixed.tab.c"
    break;

  case 51: /* expr: INTEGER  */
#line 235 "golem_fixed.y"
        {
		(yyval.ival) = (yyvsp[0].ival);
	}
#line 1382 "golem_fixed.tab.c"
    break;

  case 52: /* expr: expr PLUS expr  */
#line 239 "golem_fixed.y"
        {
		(yyval.ival) = (yyvsp[-2].ival) + (yyvsp[0].ival);
	}
#line 1390 "golem_fixed.tab.c"
    break;

  case 53: /* expr: expr MINUS expr  */
#line 243 "golem_fixed.y"
        {
		(yyval.ival) = (yyvsp[-2].ival) - (yyvsp[0].ival);
	}
#line 1398 "golem_fixed.tab.c"
    break;

  case 54: /* expr: MINUS expr  */
#line 247 "golem_fixed.y"
        {
		(yyval.ival) = -(yyvsp[0].ival);
	}
#line 1406 "golem_fixed.tab.c"
    break;

  case 55: /* expr: expr MULTIPLY expr  */
#line 251 "golem_fixed.y"
        {
		(yyval.ival) = (yyvsp[-2].ival) * (yyvsp[0].ival);
	}
#line 1414 "golem_fixed.tab.c"
    break;

  case 56: /* expr: expr DIVIDE expr  */
#line 255 "golem_fixed.y"
        {
		if ((yyvsp[0].ival) == 0) {
...
#line 1426 "golem_fixed.tab.c"
    break;

  case 57: /* expr: expr MODULO expr  */
#line 263 "golem_fixed.y"
        {
		if ((yyvsp[0].ival) == 0) {
...
#line 1438 "golem_fixed.tab.c"
    break;

  case 58: /* expr: '(' expr ')'  */
#line 271 "golem_fixed.y"
        {
		(yyval.ival) = (yyvsp[-1].ival);
	}
#line 1446 "golem_fixed.tab.c"
    break;


#line 1450 "golem_fixed.tab.c"
